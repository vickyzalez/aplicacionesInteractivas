...
*/
public class FrameSocio2 extends javax.swing.JFrame implements ActionListener{
	...
	private JLabel DNI;
    private static FrameSocio2 inst = null;
	/**
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
			FrameSocio2 inst = new FrameSocio2();
	...
	public static FrameSocio2 getFrameSocio(){
		if(inst == null){
			inst = new FrameSocio2();
		}
		return inst;
	}
